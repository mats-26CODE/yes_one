            ...
            <Grid container>
                <Grid item xs={12} sm={12} md={12} lg={12} xl={12}> 
                    <div className={'careers_header_box'}>
                        <h4>Career Growth <span id={'slash'}>/</span></h4>
                    </div>

                    <div className={'careers_intro'}>
                        <h5>
                            Constantly growing and from us, we are constantly on alert looking for pin-point 
                            talents who would like to grow with us. If you are confident with your skills and have 
                            passion to work in our innovative team, find the right position for you below and shoot your shot. 
                        </h5>
                    </div>
                </Grid>
            </Grid>
                ...
                <Grid container>
                    <Grid item xs={12} sm={12} md={12} lg={6} xl={6}>
                        <CareerPost 
                            ...
                            careerPostClick={'Are you the right fit for the job ? Click the arrow to apply now'}
                        />
                    </Grid>
                    <Grid item xs={12} sm={12} md={12} lg={6} xl={6}>
                        <CareerPost 
                ...
                <Grid container>
                    <Grid item xs={12} sm={12} md={12} lg={12} xl={12}>
                        <div className={'career_outro'}>
                            ...
                            <h5>
                                Love technology ? <IoCheckboxOutline size={'1em'} color={'#F5A623'} /> Love to create ? <IoCheckboxOutline size={'1em'} color={'#F5A623'} /> Love innovation ? <IoCheckboxOutline size={'1em'} color={'#F5A623'} /> <br />
